...
namespace IoCBuilder
{
    ...
    public class DependencyResolverFixture
    {
        ...
        public void CanResolveDependencyByType()
        {
            ...
            context.Locator.Add(new BuildKey<object>(null), obj);
        ...
        public void CanResolveDependencyByTypeAndName()
        {
            MockBuilderContext context = new MockBuilderContext();
            object obj = new object();
            context.Locator.Add(new BuildKey<object>("Foo"), obj);
            DependencyResolver resolver = new DependencyResolver(context);
        ...
        public void ResolverUsesNamesToResolveDifferences()
        {
            ...
            context.Locator.Add(new BuildKey<object>(null), obj1);

            object obj2 = new object();
            context.Locator.Add(new BuildKey<object>("Foo"), obj2);

            object obj3 = new object();
            context.Locator.Add(new BuildKey<object>("Bar"), obj3);
        ...
        public void NullTypeToResolveThrows()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => resolver.Resolve(null, typeof(object), null, NotPresentBehavior.ReturnNull, SearchMode.Local));
        }
        ...
        public void InvalidNotPresentValueThrows()
        {
            ...
            Assert.Throws<ArgumentException>(() => resolver.Resolve(typeof(object), typeof(object), null, (NotPresentBehavior)254, SearchMode.Local));
        }
