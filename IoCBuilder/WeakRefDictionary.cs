    ...
    public class WeakRefDictionary<TKey, TValue>
    {
        ...
        public void Add(TKey key, TValue value)
        {
            ...
            if (TryGet(key, out dummy))
                throw new ArgumentException(Resources.ResourceManager.GetString("KeyAlreadyPresentInDictionary"));
        ...
        {
            if (innerValue.GetType() == typeof(NullObject))
                return default(TObject);
            //else if ((innerValue as Type) == typeof(NullObject))
            else if (Type.Equals(innerValue, typeof(NullObject)))
                return default(TObject);
            else
